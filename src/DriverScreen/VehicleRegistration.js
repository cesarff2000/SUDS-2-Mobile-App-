...
const VehicleRegistration = ({ navigation, route }) => {
    ...
    const { submitVehicleRegistration, getRegistrationDetail } = useContext(
        AuthContext
    );
    ...
    const onSubmit = async (data) => {
        ...
        submitVehicleRegistration(
            {
                ...data,
                exp_date: moment(expirationDate).format("YYYY-MM-DD"),
                image: selectedImage,
            },
            () => navigation.goBack()
        );
    ...
    useEffect(
        () => (authStack ? null : getRegistrationDetail(setState, onGetSuccess)),
        []
    );
        ...
        case ERROR:
            return (
                <ListEmpty
                    ...
                    retry={() => getRegistrationDetail(setState, onGetSuccess)}
                />
            );
        case LOADING:
            return (
