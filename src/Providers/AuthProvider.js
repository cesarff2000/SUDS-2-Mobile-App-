...
const AuthProvider = ({ children }) => {
  ...
  const getToken = async () => {
    ...
    console.log("fcmauthStatus", authStatus, enabled);
    if(enabled===true) 
    {
      console.log("fcmtokenworking")
  ...
  const updateUserLocation = async () => {
    try {
      console.log("currentlocation..", getCurrentPosition)
  ...
  const login = async loginData => {
    console.log('login...',{ ...loginData, device_token: await getToken() })
