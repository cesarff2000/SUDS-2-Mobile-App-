            ...
            Data: [
                {
                    ...
                    dueAmount: "500 Rs",
                    content:
                        "Quickly embrace installed base architectures with lot of fun and activity users.",
        ...
        <View style={{ flex: 1 }}>
            ...
            >
                <View style={{ padding: 5, alignItems: "center" }}>
                    ...
                    >
                        Estimates Wash Duration 30 Mins
                    </Text>
                </View>
            </View>
        </View>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Dodge Ram 3500 Truck (No Duallys)
                            </Text>
                        </View>
                        ...
                        <View style={{ flex: 1, height: "100%", width: "100%" }}>
                            ...
                            <View style={{ justifyContent: "flex-end" }}>
                                <TouchableOpacity
                                    elevation={5}
                                    onPress={() => {
                                        navigation.navigate("Select Add Ons");
                                    }}
