            ...
            <LoadingView fetching={fetching} loading={loading}>
                <ScrollView style={styles.container}>
                    ...
                    <TouchableOpacity onPressIn={() => launchImageLibrary({}, imageSelectCallBack)} style={{ backgroundColor: 'white', borderRadius: 30, padding: 20, marginTop: 8, alignItems: 'center' }}>
                        {
                            (selectedImage) ? (
                                <View style={{ width: 100, height: 100, padding: 15, backgroundColor: Colors.blue_color, alignItems: 'center', justifyContent: 'center', borderRadius: 10, alignSelf: 'center' }}>
                                    <Image style={{ width: 95, height: 95, }} source={selectedImage} />
                                </View>
                            ) : (
